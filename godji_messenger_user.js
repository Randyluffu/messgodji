...
function openPopup(){
    ...
    legend.style.cssText = 'display:flex;gap:14px;padding:8px 14px;font-size:11px;color:rgba(0,0,0,.55);border-bottom:1px solid rgba(255,255,255,0.06);';
    legend.innerHTML = '<span><span style="display:inline-block;width:9px;height:9px;border-radius:2px;background:#f2a33c;margin-right:5px;"></span>ПК онлайн</span>'
...
function renderMap(mapWrap, data){
    ...
    Object.keys(PC_POS).forEach(function(name){
        ...
        var bg = online ? 'linear-gradient(135deg,#f2a33c 0%,#1e88e5 100%)' : 'linear-gradient(135deg,#6b6f76 0%,#8a8f98 100%)';
...
function openChat(pc){
    ...
    input.style.cssText = 'flex:1;border:1px solid rgba(255,255,255,0.15);border-radius:6px;padding:7px 10px;font-size:13px;outline:none;';
